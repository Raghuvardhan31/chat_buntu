...
```bash
curl -X POST http://192.168.31.165:3200/api/stories \
...
```bash
curl -X GET http://192.168.31.165:3200/api/stories/contacts \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
```bash
curl -X GET http://192.168.31.165:3200/api/stories/my \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
```bash
curl -X GET http://192.168.31.165:3200/api/stories/user/USER_UUID_HERE \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
```bash
curl -X GET http://192.168.31.165:3200/api/stories/STORY_ID_HERE \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
```bash
curl -X POST http://192.168.31.165:3200/api/stories/STORY_ID_HERE/view \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
```bash
curl -X GET http://192.168.31.165:3200/api/stories/STORY_ID_HERE/viewers \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
```bash
curl -X DELETE http://192.168.31.165:3200/api/stories/STORY_ID_HERE \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```

...
class CallNotifier extends ChangeNotifier {
  ...
  /// IMPORTANT: callId and channelName are generated by the caller (UI) and
  /// passed through here to the server. We do NOT generate our own to avoid
  /// mismatches between what the UI uses and what the server receives.
  Future<void> initiateCall({
    ...
    try {
      ...
      debugPrint('[CALL] provider: Initiated callId=$callId channel=$channelName');
    } catch (e) {
      debugPrint('[CALL] provider: Failed to initiate call signal: $e');
